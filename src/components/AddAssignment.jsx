...
const AddAssignment = () => {
    const handleAddCoffee=event=>{
        ...
        const newCoffee={photo,spotName,countryName,location}
                ...
                <div className="md:flex gap-4">
                    ...
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            ...
                            <input name="spotName" type="text" placeholder="Assignment Name" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
                ...
                <div className="md:flex gap-4">
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            ...
                            <input name="countryName" type="text" placeholder="Category Name" className="input input-bordered w-full" />
                        </label>
                    </div>
                    <div className="form-control md:w-1/2">
                        <label className="label">
                        ...
                        <label className="input-group">
                            ...
                            <input name="location" type="text" placeholder="Purpose" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
